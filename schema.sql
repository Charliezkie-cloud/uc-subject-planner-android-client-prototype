...
-- NOTE: confirm with UCB registrar whether 3.00 exactly counts as
-- passing or failing for this program — currently treated as passing.
...
CREATE INDEX idx_coreq_subject            ON corequisites(subject_id);
CREATE INDEX idx_completed_subject        ON completed_subjects(subject_id);
CREATE INDEX idx_planned_term             ON planned_subjects(planned_school_year, planned_term);
